...
public class FlowVerifyMFA extends Client {
    ...
    // TODO: Doc
    public FlowVerifyMFACompleteResponse complete(FlowVerifyMFACompleteRequest request) throws PangeaException, PangeaAPIException{
        return doPost("/v1/flow/verify/mfa/complete", request, FlowVerifyMFACompleteResponse.class);
    }


    // TODO: Doc
    public FlowVerifyMFAStartResponse start(String flowID, MFAProvider mfaProvider) throws PangeaException, PangeaAPIException{
