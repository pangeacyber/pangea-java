...
public class FileIntelClient extends Client {
	 ...
	 * }
	 */
	public FileLookupResponse lookup(String hash, String hashType, String provider)
		throws PangeaException, PangeaAPIException {
	 ...
	 * }
	 */
	public FileLookupResponse lookup(String hash, String hashType, boolean verbose, boolean raw)
		throws PangeaException, PangeaAPIException {
	 ...
	 * }
	 */
	public FileLookupResponse lookup(String hash, String hashType, String provider, boolean verbose, boolean raw)
		throws PangeaException, PangeaAPIException {
		return lookupPost(hash, hashType, provider, verbose, raw);
	}

	private FileReputationResponse reputationPost(
		String hash,
		String hashType,
		String provider,
		Boolean verbose,
	 ...
	 * }
	 */
	public FileReputationResponse reputation(String hash, String hashType, String provider)
		throws PangeaException, PangeaAPIException {
	 ...
	 * }
	 */
	public FileReputationResponse reputation(String hash, String hashType, boolean verbose, boolean raw)
		throws PangeaException, PangeaAPIException {
	 ...
	 * }
	 */
	public FileReputationResponse reputation(
		String hash,
		String hashType,
		String provider,
		boolean verbose,
