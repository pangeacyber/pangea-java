...
public class StoreFileUploader extends BaseClient {

	public static String serviceName = "StoreFileUploader";

	public StoreFileUploader(Builder builder) {
	...
	public void uploadFile(String url, TransferMethod transferMethod, FileData fileData)
		...
		if (transferMethod == TransferMethod.MULTIPART) {
			throw new PangeaException(
				String.format("%s not supported. Use StoreClient.put() instead", transferMethod),
				null
			);
		}
