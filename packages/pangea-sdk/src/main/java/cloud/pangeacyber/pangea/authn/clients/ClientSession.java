...
public class ClientSession extends Client {
    ...
    // TODO: Doc
    public ClientSessionInvalidateResponse invalidate(String token, String sessionID) throws PangeaException, PangeaAPIException{
    ...
    // TODO: Doc
    public ClientSessionRefreshResponse refresh(String refreshToken, String userToken) throws PangeaException, PangeaAPIException{
