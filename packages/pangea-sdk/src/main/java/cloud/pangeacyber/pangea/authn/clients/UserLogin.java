...
public class UserLogin extends Client {
    ...
    // TODO: Doc
    public UserLoginResponse Password(String email, String password, Profile extraProfile) throws PangeaException, PangeaAPIException{
        UserLoginPasswordRequest request = new UserLoginPasswordRequest(email, password, extraProfile);
        return doPost("/v1/user/login/password", request, UserLoginResponse.class);
    }

    // TODO: Doc
    public UserLoginResponse Social(IDProvider provider, String email, String socialID) throws PangeaException, PangeaAPIException{
    ...
    // TODO: Doc
    public UserLoginResponse Social(IDProvider provider, String email, String socialID, Profile extraProfile) throws PangeaException, PangeaAPIException{
