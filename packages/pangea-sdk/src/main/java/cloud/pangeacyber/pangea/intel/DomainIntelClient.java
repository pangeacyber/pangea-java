...
public class DomainIntelClient extends Client{
    ...
    private DomainReputationResponse reputationPost(String domain, String provider, Boolean verbose, Boolean raw) throws PangeaException, PangeaAPIException{
     ...
     * }
     */
    public DomainReputationResponse reputation(String domain, String provider) throws PangeaException, PangeaAPIException {
     ...
     * }
     */
    public DomainReputationResponse reputation(String domain, boolean verbose, boolean raw) throws PangeaException, PangeaAPIException {
     ...
     * }
     */
    public DomainReputationResponse reputation(String domain, String provider, boolean verbose, boolean raw) throws PangeaException, PangeaAPIException {
