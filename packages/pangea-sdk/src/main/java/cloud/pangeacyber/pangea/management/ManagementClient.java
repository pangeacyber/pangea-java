...
final class AuthorizationClient extends BaseClient {
	...
	public AccessClientInfo getClient(final String clientId) throws PangeaException, PangeaAPIException {
		return this.getNonPangeaResponse(String.format("/v1beta/oauth/clients/%s", clientId));
	}
	...
	private <Res> Res getNonPangeaResponse(final String path) throws PangeaException, PangeaAPIException {
		return this.getNonPangeaResponse(path, null);
	}

	private <Res> Res getNonPangeaResponse(final String path, final Map<String, String> params)
		throws PangeaException, PangeaAPIException {
